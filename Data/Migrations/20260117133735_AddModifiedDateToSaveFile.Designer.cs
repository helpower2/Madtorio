...
namespace Madtorio.Data.Migrations
{
    ...
    [Migration("20260117133735_AddModifiedDateToSaveFile")]
    partial class AddModifiedDateToSaveFile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Madtorio.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Madtorio.Data.Models.ServerConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Madtorio.Data.ApplicationUser", null)
                        .WithMany()
